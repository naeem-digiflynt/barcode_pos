                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if($pos_settings->purchase_code == 'purchase_code' || $pos_settings->envato_username == 'envato_username'){
                            echo admin_form_open('pos/updates');
                        ?>
                            ...
                            if (!empty($updates->data->updates)) {
                                ...
                                foreach ($updates->data->updates as $update) {
                                    ...
                                    if ($c == 1 && $update->mversion != 315) {
                                        echo anchor('admin/pos/install_update/' . substr($update->filename, 0, -4) . '/' . (!empty($update->mversion) ? $update->mversion : 0) . '/' . $update->version, '<i class="fa fa-download"></i> ' . lang('install'), 'class="btn btn-primary pull-right"') . ' ';
                                    }
